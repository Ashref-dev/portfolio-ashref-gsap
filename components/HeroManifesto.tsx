    ...
    const ctx = gsap.context(() => {
      ...
      if (canvas) {
        ...
        const drawArrow = () => {
          ...
          const opacity = Math.min(0.8, (dist - 100) / 400) * arrowState.alpha;
          if (opacity <= 0) return;
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="bg-blob-1 absolute top-[10%] left-[10%] size-[25vw] bg-rose-300/20 rounded-full blur-[100px] mix-blend-multiply opacity-80" />
        <div className="bg-blob-2 absolute bottom-[10%] right-[10%] size-[20vw] bg-blue-300/20 rounded-full blur-[100px] mix-blend-multiply opacity-80" />
      </div>
