...
- Never use emojis
- don't output the code in the chat directly, use the tools to apply it to the project files, unless small snippets to explain something.
- Make sure to handle edge cases and errors early and correctly, at all times.
- Always maintain modern, elegant and consistent design, look for context in the project if you are unsure before execting.
